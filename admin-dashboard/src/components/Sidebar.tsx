    ...
    <aside className="w-64 flex-shrink-0 bg-slate-900 border-r border-slate-800 flex flex-col">
      ...
      <div className="p-6 border-b border-slate-800">
        <div className="flex items-center gap-3">
          <div className="w-9 h-9 rounded-xl brand-gradient flex items-center justify-center text-white font-bold text-lg shadow-lg">
            V
          </div>
          <div>
            <div className="font-bold text-white text-sm leading-none">VibeSync</div>
      ...
      <div className="p-4 border-t border-slate-800 text-xs text-slate-600">
        VibeSync v2.4.0<br />
        <span className="text-brand-teal">● Backend Connected</span>
      </div>
    </aside>
  );
}
